import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; import javax.sound.midi.*; import javax.sound.midi.spi.*; import javax.sound.sampled.*; import javax.sound.sampled.spi.*; import java.util.regex.*; import javax.xml.parsers.*; import javax.xml.transform.*; import javax.xml.transform.dom.*; import javax.xml.transform.sax.*; import javax.xml.transform.stream.*; import org.xml.sax.*; import org.xml.sax.ext.*; import org.xml.sax.helpers.*; public class Vu_Ha extends PApplet {/*
 * Vu Ha - vha3
 * Napkin drawing
 */
...
// Instance variables
  // colors
int liquid;
int choice1 = color(255,223,128);
int choice2 = color(102,68,0);
int choice3 = color(51,0,0);
int choice4 = color(153,0,77);
int choice5 = color(229,255,255);
...
public void drawBackground(){
  ...
  // cup
  for (int i=0; i<10; i++){
    int cupColor = color(153-i*10,179-i*10,204-i*10);
    fill(cupColor);
    stroke(cupColor);
...
class Effect{
  ...
  Effect(int x, int y, int baseColor, int spread, boolean blended){
   this.x = x;
   this.y = y;
  ...
  Effect(int x, int y, float xOffset, float yOffset, int baseColor, int spread, boolean blended){
   this.x = x;
   this.y = y;
  ...
  static public void main(String args[]) {     PApplet.main(new String[] { "Vu_Ha" });  }}